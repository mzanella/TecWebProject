...
my $description = "Conferma dell'inserimento di un film in sala";
...
$nomeBC="<a href=\"Amministrazione.cgi\">Amministrazione</a> <span class=\"breadcrumb\">-&gt;</span> <a href=\"SceltaInserimentoFilmSala.cgi\">Inserisci film in sala</a> <span class=\"breadcrumb\">-&gt;</span> <a href=\"InserisciNuovoFilmSala.cgi\">Inserisci un nuovo film in sala</a> <span class=\"breadcrumb\">-&gt;</span> ".$nomePagina;
...
if (DBFunctions::controlAdmin($session->param("utenteEmail")) == 0){
	...
	<h1>Film inserito con successo</h1>
		<p class=\"messaggioConferma\">Il film è stato inserito nella sezione <a href=\"OraInSala.cgi\">Ora in sala</a>.</p>
