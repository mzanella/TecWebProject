...
$nomeBC="<a href=\"Amministrazione.cgi\">Amministrazione</a> <span class=\"breadcrumb\">-&gt;</span> ".$nomePagina;
...
if (DBFunctions::controlAdmin($session->param("utenteEmail")) == 0){
	...
	<form id=\"frmFilm\" action=\"perl/controlloSelezioneFilmDaModificareProssimamente.cgi\" method=\"post\" onsubmit=\"return validaForm();\">
		<fieldset>
			<legend>Film da modicare</legend>";
