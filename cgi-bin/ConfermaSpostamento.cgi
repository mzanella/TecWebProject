...
$nomeBC="<a href=\"Amministrazione.cgi\">Amministrazione</a> <span class=\"breadcrumb\">-&gt;</span> <a href=\"InserisciNuovoFilmSala.cgi\">Inserisci film in sala</a> <span class=\"breadcrumb\">-&gt;</span> <a href=\"\">Seleziona film da spostare in sala</a> <span class=\"breadcrumb\">-&gt;</span>".$nomePagina;
...
if (DBFunctions::controlAdmin($session->param("utenteEmail")) == 0){
	...
	print
	"
	<h1>Spostamento avvenuto con successo</h1>
		<p class=\"messaggioConferma\">Il film è stato spostato dalla sezione \"Prossimamente\" a \"Ora in sala\".</p>
