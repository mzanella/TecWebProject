...
my $description = "Conferma dello rimozione di un film";
...
$nomeBC="<a href=\"Amministrazione.cgi\">Amministrazione</a> <span class=\"breadcrumb\">-&gt;</span> <a href=\"CancellaFilm.cgi\">Cancella film</a> <span class=\"breadcrumb\">-&gt;</span> ".$nomePagina;
...
if (DBFunctions::controlAdmin($session->param("utenteEmail")) == 0){
	...
	<h1>Rimozione avvenuta con successo</h1>
		<p class=\"messaggioConferma\">Il film è stato tolto dalla sezione <a href=\"TuttiIFilm.cgi\">Tutti i film</a></p>
