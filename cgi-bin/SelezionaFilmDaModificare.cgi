...
my $nomePagina = "Seleziona film da modificare - Amministrazione - InstaFilm";
my $description = "Pagina per selezione un film già recensito per modificarlo";
my $keyword = "Film, Cinema, InstaFilm, Film in sala";
PageSkeleton::printHeadEnd($nomePagina, $description, $keyword);
PageSkeleton::printHeadEnd($nomePagina);
PageSkeleton::printBodyStart();
PageSkeleton::printHeader();
PageSkeleton::printNav($nomePagina);
#creazione breadcrumb
$nomeBC="<a href=\"Amministrazione.cgi\">Amministrazione</a> <span class=\"breadcrumb\">-&gt;</span> "."Seleziona film da modificare";
...
if (DBFunctions::controlAdmin($session->param("utenteEmail")) == 0){
	...
	<form id=\"frmFilm\" action=\"perl/controlloSelezioneFilmDaModificare.cgi\" method=\"post\" onsubmit=\"return validaForm();\">
		<fieldset>
			...
			print"<label for=\"film\">Seleziona film:</label>
			...
			print "<input type=\"submit\" value=\"Modifica film\" />
		</fieldset>
	</form>";
}
#Fine contenuto
